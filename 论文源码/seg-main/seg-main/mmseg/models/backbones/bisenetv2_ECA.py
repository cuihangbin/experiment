...
class DetailBranch(BaseModule):
    ...
    def __init__(self,
        ...
        self.eca_1 = ECA(int(detail_channels[0]))
        self.eca_2 = ECA(int(detail_channels[1]))
        self.eca_3 = ECA(int(detail_channels[2]))
    def forward(self, x):
        for i, stage in enumerate(self.detail_branch):
            x = stage(x)
            if i == 0:
                x = self.eca_1(x)
            if i == 1:
...
class SemanticBranch(BaseModule):
    ...
    def __init__(self,
        ...
        ############################
        self.eca_1 = ECA(int(semantic_channels[0]))
        self.eca_2 = ECA(int(semantic_channels[1]))
        self.eca_3 = ECA(int(semantic_channels[2]))
        self.eca_4 = ECA(int(semantic_channels[3]))
        ############################
...
class BiSeNetV2_ECA(BaseModule):
    ...
    def __init__(self,
        ...
        super(BiSeNetV2_ECA, self).__init__(init_cfg=init_cfg)
        self.in_channels = in_channels
