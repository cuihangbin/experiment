...
target_layers = ['model_17_cv3', 'model_20_cv3', 'model_23_cv3']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="last.pt", help='Path to the model')
...
parser.add_argument('--target-layer', type=str, default='model_17_cv3',
